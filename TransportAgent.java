...
public class TransportAgent implements TickListener, CommUser, RoadUser {
	...
	private void setBound(ProtocolMessage pm)
	{
		...
		DeliveryRecorder.setDeliveryBoundTime(pm.getContractId(), timeIndex);
	...
	void broadcastCFPs()
	{
		...
		for (String contractID : state.keySet())
		{
			...
			if (s == ContractNet.TransportAgentState.ASSIGNED || s == ContractNet.TransportAgentState.AWARDING )
			{
